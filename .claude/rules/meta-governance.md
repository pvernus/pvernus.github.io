...
| Session logs | Project-dependent | `.claude/session-log.md` (this project: gitignored, per `.claude/rules/logging.md`) | ❌ No here |
| Handoff state | ❌ No | `.claude/handoff.md` (gitignored; overwritten each `/done`) | ❌ No |
